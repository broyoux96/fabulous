...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('formarisan')); ?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="pages/forms/advanced.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Fabulous Paket Lebaran</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/forms/advanced.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Fabulous Party Pleaner</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/forms/advanced.html" class="nav-link">
    ...
    <!-- /.sidebar -->
  </aside><?php /**PATH C:\Users\BROYOUX\Documents\Application\fabulouscorp\resources\views/layout/sidebar.blade.php ENDPATH**/ ?>