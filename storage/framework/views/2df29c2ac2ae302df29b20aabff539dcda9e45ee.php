    ...
    <div class="row">
      ...
      <div class="col-12">
        ...
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="<?php echo e(url('tablearisan')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="card-body">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BROYOUX\Documents\Application\fabulouscorp\resources\views/formarisan/formarisan.blade.php ENDPATH**/ ?>